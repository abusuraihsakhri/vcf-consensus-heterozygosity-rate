"""
Automated Pytest for vcf-consensus-heterozygosity-rate Enrichment Modules.
"""
import sys
...
from enrichment import (
    StructuralVariantSvCallingIntegrationFromLongreadDataEngine,
    RationaleEngine,
    ImplementationPlanEngine,
    VariantQualityScoreCompositeAndCohortComparisonEngine,
    RationaleEngine,
    ImplementationPlanEngine,
    VcfconsensusheterozygosityrateEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = VcfconsensusheterozygosityrateEnrichmentSuite()
